...
/**
 * Per-tenant config: CIF format, limits, feature toggles. One entry exists
 * today (the single live bank) but this stays wired from day one so the
 * next bank's onboarding is a config change, not a fork.
 */
@Component
...
public class BankConfigProperties {
    ...
    public static class Tenant {
        ...
        private long dailyTransferLimitMinorUnits;
    }
}

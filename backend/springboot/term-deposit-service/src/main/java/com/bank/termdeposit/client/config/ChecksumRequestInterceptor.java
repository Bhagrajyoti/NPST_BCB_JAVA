package com.bank.termdeposit.client.config;

import com.bank.termdeposit.common.security.checksum.ChecksumProperties;
import com.bank.termdeposit.common.security.checksum.ChecksumUtil;
...
public class ChecksumRequestInterceptor implements RequestInterceptor {
    ...
    private static final String THIS_SERVICE_NAME = "term-deposit-service";
